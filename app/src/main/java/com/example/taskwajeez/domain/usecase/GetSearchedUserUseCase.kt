...
class GetSearchedUserUseCase(private val userRepository: UserRepository) {

     fun execute(searchQuery: String) : Resource<Flow<List<User>>> = userRepository.getSearchedUser(searchQuery)
